...
function setup() {
    ...
    song = loadSound("assets/Ketsa_Peace-Love.mp3", loaded); // trigger function "loaded" when the sound is ready
...
function mousePressed() {
    ...
    // can i make this only toggle when the user clicks inside the shape?
    if (!song.isPlaying()) {
        song.play();
