...
function draw() {
    ...
    // TODO different type face?
    textSize(20);
    text('Attempts: ' + gameState.attempts, 370, 156);
    text('Matches: ' + gameState.numMatched, 372, 180);
}
